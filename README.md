...
<p align="center">
    ...
    ·
    <a href="https://github.com/ROSHAN-Z89/terminal-portfolio/issues">Found a Bug</a>
    ·
    <a href="https://github.com/ROSHAN-Z89/terminal-portfolio/issues">Request Feature</a>
  </p>
</p>

![App Screenshot](https://raw.githubusercontent.com/ROSHAN-Z89/terminal-portfolio/master/static/PortfolioSS.png "Screenshot of app")
...
1. Clone the terminal portfolio
   ...
   ```sh
   git clone https://github.com/ROSHAN-Z89/terminal-portfolio.git
   ```
...
popupGithubLink: "https://github.com/ROSHAN-Z89/country-quiz"
techIcons: [
        "react",
        "html5",
        "css3",
